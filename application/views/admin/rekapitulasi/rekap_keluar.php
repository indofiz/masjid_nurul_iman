        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 ">
            ...
            <div class="card mb-3">
              <div class="x_panel">
                <div class="x_title">
                  <h2> List Pengeluaran <?= $bulan_terbilang; ?> <?= $tahun; ?></h2>
                  <div class="clearfix"></div>
                </div>
                <div class="x_content">
                          ...
                          <tbody>
                            ...
                            foreach ($kategori_pengeluaran as $kat_pengeluaran) : ?>
                              ...
                              <tr>
                                ...
                                <td><?= $kat_pengeluaran['nama_kategori_keluar']; ?></td>
                                <td align="center"><?= $total_transaksi; ?></td>
                                <td align="right" style="padding-right: 90px">Rp. <?= rupiah($total_perkategori_keluar); ?>
                                </td>
                              </tr>
                            <?php endforeach; ?>
                            <!-- End Modal -->
                      ...
                      <div class="card-box table-responsive">
                        <table class="display table table-striped table-bordered " style="width:100%">
                          ...
                          <tbody>
                            <?php
                            $no = 1;
                            foreach ($list_bulanan_keluar as $pengeluaran) : ?>
                              <tr>
                                <td align="center"><?= $no++; ?></td>
                                <td><?= $pengeluaran['nama_kategori_keluar']; ?></td>
                                <td align="center"><?= $pengeluaran['tanggal']; ?></td>
                                <td align="left" style="padding-right: 90px">Rp. <?= rupiah($pengeluaran['nominal']); ?>
                                </td>
